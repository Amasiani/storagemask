        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid" src="temp/assets/img/about.png" alt="">
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="temp/assets/img/icon-7.png" alt="">
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="temp/assets/img/icon-6.png" alt="">
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="temp/assets/img/icon-5.png" alt="">
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="temp/assets/img/icon-4.png" alt="">
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="temp/assets/img/icon-3.png" alt="">
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="temp/assets/img/icon-8.png" alt="">
                        <div class="ps-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="temp/assets/img/icon-7.png" alt="">
                        <h5 class="mb-3">{{ $plan->name }}</h5>
                        <p>Minimum deposit: ${{ $plan->min_deposit }}</p>
                        <p>Maximum deposit: ${{$plan->max_deposit }}</p>
                        <p>Plan profit: {{ $plan->profit }}%</p>
                        <p>Contact life: {{ $plan->contact_life == 14 ?  $plan->contact_life . ' ' . 'Days' : $plan->contact_life . ' ' . 'Months'   }}</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="temp/assets/img/icon-3.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="temp/assets/img/icon-5.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="temp/assets/img/icon-8.png" alt="">
        ...
        <div class="container py-5">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 text-center">
                    <img class="img-fluid m-1" src="temp/assets/img/payment-1.png" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="temp/assets/img/payment-2.png" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="temp/assets/img/payment-3.png" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="temp/assets/img/payment-4.png" alt="" style="width: 50px;">
                </div>
            </div>
        </div>
    </div>

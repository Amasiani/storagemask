      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-1 pb-1 mb-0.5 d-flex">
          ...
          <div class="info">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item"><a class="nav-link" href="{{ route('fund') }}">Fund Account</a></li>
        ...
        <div class="btn btn-group mt-1">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="{{ route('admin.referred') }}">Referrals</a></li>
            <li><a class="dropdown-item" href="{{ route('admin.cashwithdrawals.index') }}">Withdrawals</a></li>
          </ul>
          @endauth
        </div>
        @endcanany

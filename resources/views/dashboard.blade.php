...
<section>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-2"><a class="btn btn-primary float-end mb-2" role="button" href="{{ route('admin.investments.create') }}">Invest</a></div>
            @auth
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Account Deposited</th>
